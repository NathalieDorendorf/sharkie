class PufferFish extends MovableObject {
    ...
    IMAGES_PUFFER_FISH_GREEN_TRANSITION = [
    ...
    IMAGES_PUFFER_FISH_YELLOW_TRANSITION = [
    ...
    IMAGES_PUFFER_FISH_YELLOW_DEAD = [
    ...
    IMAGES_PUFFER_FISH_RED_TRANSITION = [
    ...
    animate() {
        ...
        setInterval(() => {
            this.playAnimation(this.IMAGES_PUFFER_FISH_GREEN);
        }, 250);
    }
